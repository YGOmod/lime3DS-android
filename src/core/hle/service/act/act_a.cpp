...
ACT_A::ACT_A(std::shared_ptr<Module> act) : Module::Interface(std::move(act), "act:a") {
    const FunctionInfo functions[] = {
        ...
        {0x001B, nullptr, "AcquireOtherTypePrincipalID?"},
        {0x001C, nullptr, "GetCachedIndependentServiceToken"},
        {0x001D, nullptr, "InquireMailAddress"},
        {0x001E, nullptr, "AcquireEula"},
        {0x001F, nullptr, "AcquireEulaLanguageList"},
        {0x0020, nullptr, "AcquireIndependentServiceTokenV2"},
        {0x0021, nullptr, "GetIndepdendentServiceTokenV2"},
        {0x0022, nullptr, "GetCachedIndependentServiceTokenV2"},
        // act:a
        ...
        {0x0425, nullptr, "SendConfirmationMail"},
        {0x0428, nullptr, "ApproveByCreditCard"},
        {0x0429, nullptr, "SendCoppaCodeMail"},
